...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.add_contact(wd, "John", "Doe", "City, random street, 1 building", "3417698", "+79342319032",
                         "test@test.ru")
    ...
    def add_contact(self, wd, firstname, lastname, address, home_number, phone_number, email):
        ##add firstname
        ...
        wd.find_element_by_name("mobile").send_keys("%s" % phone_number)
        #add email
